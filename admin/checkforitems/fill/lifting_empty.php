...
<h3 style="margin-top: 20px;">Элементы каталога с незаполненным свойством "Стоимость подъёма":</h3>
...
if (!empty($iBlocks_Elements_Name)) {
    foreach ($iBlocks_Elements_Name as $iBlocks_Elements_Name_Id => $iBlocks_Elements_Name_Name) {
        ...
        <div style="margin-bottom: 10px;">
            <div>
                <div>
                    Свойство "Стоимость подъёма" не заполнено в элементе: <strong><?= $iBlocks_Elements_Name_Name ?></strong>
                </div>
                <div>
...
if ($iBlocks_Elements_Repeat_Count === 0): ?>
    <div style="margin-bottom: 10px;">
        Все элементы каталога имеют заполненное свойство "Стоимость подъёма".
    </div>
<?
endif; ?>
